File 0-helloworld is a script that prints "Hello, World", followed by a new line to the standard output.

File 1-confusedsmiley is a script that displays a confused smiley "(Ôo)'.
...
File 6-thirdline is a script that displays the third line of the file iacta.
...
File 103-the_biggest_fan is a script that parses web servers logs in TSV format as input and displays the 11 hosts or IP addresses which did the most requests.:x
